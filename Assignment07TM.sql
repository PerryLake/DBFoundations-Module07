...
Select Top 100000
	C.CategoryName
	, [InvnetoryDate] = DateName (MM, I.InventoryDate) + ',' + DateName (YY, I.InventoryDate)
	, [InventoryCountbyCategroy] = Sum(I.[Count])
From
	vCategories as C join vProducts as P
		on C.CategoryID = P.CategoryID
...
Order By CategoryName, Month (InventoryDate), InventoryCountbyCategroy; 
go
